...
function randomColors() {
  // Keep the initial colors in array
  initialColors = [];
  ...
  colorDivs.forEach((div) => {
    ...
    colorizedSlider(color, hue, bright, sat);
  });
  resetInput();
...
function colorizedSlider(color, hue, bright, sat) {
  //Scale Saturation
